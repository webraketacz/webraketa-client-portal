...
export default function RegisterPage() {
  ...
  // volitelné: potvrzení hesla (lepší UX)
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    // ✅ pokud už máme user id (většinou ano), uložíme výběr balíčku do profiles
    // (tím zajistíme, že se "neztratí" ani po refreshi nebo po potvrzení emailu)
    ...
    if (userId) {
      ...
      if (upsertError) {
        // nezastavujeme registraci, ale ukážeme info
    ...
    // ✅ Pokud email potvrzení nemáš, rovnou přihlásí a jde na onboarding
              ...
              <div className="mt-10 grid max-w-xl grid-cols-1 gap-4 sm:grid-cols-2">
                <div className="rounded-2xl border border-white/10 bg-white/[0.06] p-5 backdrop-blur-xl">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <div className="text-sm font-semibold text-white">Bezpečný účet</div>
                      <p className="mt-1 text-sm text-zinc-400">
                        Přístup jen pro vás, chráněno moderním zabezpečením.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="rounded-2xl border border-white/10 bg-white/[0.06] p-5 backdrop-blur-xl">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <div className="text-sm font-semibold text-white">Přehled projektu</div>
                      <p className="mt-1 text-sm text-zinc-400">
                        Všechny informace a kroky na jednom místě.
                      </p>
                    </div>
                  </div>
                </div>
